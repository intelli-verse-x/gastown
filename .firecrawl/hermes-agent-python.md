[Skip to main content](https://hermes-agent.nousresearch.com/docs/guides/python-library#__docusaurus_skipToContent_fallback)
...
## Installation [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#installation "Direct link to Installation")
...
## Basic Usage [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#basic-usage "Direct link to Basic Usage")
...
## Full Conversation Control [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#full-conversation-control "Direct link to Full Conversation Control")
...
## Configuring Tools [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#configuring-tools "Direct link to Configuring Tools")
...
## Multi-turn Conversations [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#multi-turn-conversations "Direct link to Multi-turn Conversations")
...
## Saving Trajectories [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#saving-trajectories "Direct link to Saving Trajectories")
...
## Custom System Prompts [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#custom-system-prompts "Direct link to Custom System Prompts")
...
## Batch Processing [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#batch-processing "Direct link to Batch Processing")
...
## Integration Examples [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#integration-examples "Direct link to Integration Examples")

### FastAPI Endpoint [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#fastapi-endpoint "Direct link to FastAPI Endpoint")
...
### Discord Bot [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#discord-bot "Direct link to Discord Bot")
...
### CI/CD Pipeline Step [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#cicd-pipeline-step "Direct link to CI/CD Pipeline Step")
...
## Key Constructor Parameters [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#key-constructor-parameters "Direct link to Key Constructor Parameters")
...
## Important Notes [​](https://hermes-agent.nousresearch.com/docs/guides/python-library\#important-notes "Direct link to Important Notes")
...
- [Installation](https://hermes-agent.nousresearch.com/docs/guides/python-library#installation)
- [Basic Usage](https://hermes-agent.nousresearch.com/docs/guides/python-library#basic-usage)
- [Full Conversation Control](https://hermes-agent.nousresearch.com/docs/guides/python-library#full-conversation-control)
- [Configuring Tools](https://hermes-agent.nousresearch.com/docs/guides/python-library#configuring-tools)
- [Multi-turn Conversations](https://hermes-agent.nousresearch.com/docs/guides/python-library#multi-turn-conversations)
- [Saving Trajectories](https://hermes-agent.nousresearch.com/docs/guides/python-library#saving-trajectories)
- [Custom System Prompts](https://hermes-agent.nousresearch.com/docs/guides/python-library#custom-system-prompts)
- [Batch Processing](https://hermes-agent.nousresearch.com/docs/guides/python-library#batch-processing)
- [Integration Examples](https://hermes-agent.nousresearch.com/docs/guides/python-library#integration-examples)
  - [FastAPI Endpoint](https://hermes-agent.nousresearch.com/docs/guides/python-library#fastapi-endpoint)
  - [Discord Bot](https://hermes-agent.nousresearch.com/docs/guides/python-library#discord-bot)
  - [CI/CD Pipeline Step](https://hermes-agent.nousresearch.com/docs/guides/python-library#cicd-pipeline-step)
- [Key Constructor Parameters](https://hermes-agent.nousresearch.com/docs/guides/python-library#key-constructor-parameters)
- [Important Notes](https://hermes-agent.nousresearch.com/docs/guides/python-library#important-notes)